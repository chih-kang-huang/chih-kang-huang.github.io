...
default-theme: dark
include-in-header: 
  - header_includes.html # <-- FIXED LINE: Instructs Quarto to include the file content
---
...
<div class="button-container">
  ...
  <a href="#works" class="btn btn-outline-primary">Scientific Works</a>
...
2. E.Bretin, **C-K. Huang**, S. Masnou. [**A thickness-aware Allen-Cahn equation for the mean curvature flow of thin structures**](https://arxiv.org/abs/2310.10272), accepted.
3. **C-K. Huang**. [**Questions of approximation and compactness for geometric variational problems**](https://theses.hal.science/tel-03584255), Thesis, Université de Lyon, 2021
4. **C-K. Huang**. [Asymptotic Analysis of embedded Willmore spheres in 3-dimensional manifolds](https://arxiv.org/abs/1710.08732).
5. L. Gagnon, **C-K. Huang**. Null controllability of Allen-Cahn eqaution, in preparation.


<details> 
  <summary><h3 style="display: inline;">Presentations</h3></summary>
  <ul>
  Under construction
  <!---
